...
${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o: D:/FinalHSM.X/TemplateEventChecker.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1740230945" 
	@${RM} ${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o.d 
	@${RM} ${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DEVENTCHECKER_TEST -I"." -I"C:/CMPE118/include" -MMD -MF "${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o.d" -o ${OBJECTDIR}/_ext/1740230945/TemplateEventChecker.o D:/FinalHSM.X/TemplateEventChecker.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
